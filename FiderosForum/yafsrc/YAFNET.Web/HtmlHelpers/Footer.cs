...
public static class FooterHtmlHelper
{
    ...
    public static IHtmlContent FooterHelper(this IHtmlHelper _)
    {
        ...
        content.AppendHtml("<div style=\"color:white; background-color:rgb(25, 36, 79);height:100px; display: flex;justify-content: center;align-items: center;border: 3px solid; \">");
    ...
    private static void RenderRulesLink(HtmlContentBuilder content)
    {
        ...
        rulesTag.MergeAttribute(HtmlAttribute.Style, "color:white");
    ...
    private static void RenderVersion(HtmlContentBuilder content)
    {
        ...
        yafUrlTag.MergeAttribute(HtmlAttribute.Title, "Fideros");
        yafUrlTag.MergeAttribute(HtmlAttribute.Style, "color:white");
        yafUrlTag.MergeAttribute(HtmlAttribute.Href, "https://www.fideros.com");
        ...
        yafCopyrightTag.MergeAttribute(HtmlAttribute.Title, "Fideros");
        yafCopyrightTag.MergeAttribute(HtmlAttribute.Style, "color:white");
        yafCopyrightTag.MergeAttribute(HtmlAttribute.Href, "https://www.fideros.com");

        yafCopyrightTag.InnerHtml.Append($"Fideros © 2023-{DateTime.UtcNow.Year} - All right reserved.");
